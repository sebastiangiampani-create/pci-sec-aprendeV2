(() => {
  ...
  function decorate(){
    ...
    if(management){
      ...
      const p=management.querySelector('p');if(p)p.textContent='Docentes, cargos, asignaciones, cursos y estudiantes en una gestión conectada con el Desarrollo Curricular.';
